  const SkillCard = ({title, discreption, logo})=> {
    ...
    <>
<div className="">
      <div className="bg-[url('src/assets/images/skill-card-bg.jpg')] h-[9rem] bg-cover bg-neutral-500 bg-blend-mulitply gap-6 grid rounded-lg grid-cols-[80fr_20fr] pl-6 pt-6">
